...
export class ComponentHarnessSuperclass extends ContentContainerComponentHarness {
  ...
  /**
   * Searches for all instances of the component corresponding to the given harness type under the document root element, and returns a list {@linkcode ComponentHarness} for each instance.
   */
  ...
  /**
   * Gets a {@linkcode HarnessLoader} for the document root element. This loader can be used for elements that a component creates outside its own root element (e.g. by appending to `document.body`).
   */
