...
describe('ComponentHarnessSuperclass', () => {
  it('has a working getTopLevelHarness()', async () => {
    @Component({
  ...
  it('has a working getAllTopLevelHarnesses()', async () => {
    @Component({
      selector: 'sl-inner-component',
      standalone: true,
      template: ``,
  ...
  it('allows harness to restrict their loaders to sub-components (a bug that bugged me for a long time!)', async () => {
    @Component({
      selector: 'sl-inner-component',
