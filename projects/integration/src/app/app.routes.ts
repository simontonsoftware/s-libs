...
import { SignalStatePerformanceComponent } from './signal-state-performance/signal-state-performance.component';
...
export const routes: Routes = [
  ...
  { path: 'signal-state-performance', component: SignalStatePerformanceComponent },
